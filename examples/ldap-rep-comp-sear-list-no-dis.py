...
#
# Report Computers in an AD that match the look for string and are not disabled, list the computers (chosen attributes)
#
# # Run this in the command line while on the palazo directory so python can find serv
# export PYTHONPATH=`pwd`
# python3 examples/ldap-rep-comp-sear-list-no-dis.py

from serv.ldaps import ldap_connect, find_computers_filtered_no_dis, ldap_disconnect
...
if proceed:
    ...
    my_list = find_computers_filtered_no_dis(BASE, connection, look_for,
